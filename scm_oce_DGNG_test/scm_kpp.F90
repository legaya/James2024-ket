...
!===================================================================================================
subroutine lmd_kpp_LMD94(N,Akv,Akt,hbl,u,v,t,bvf,rho1,z_r,z_w,Hz,Ricr,f,sustr,svstr,srflx,stflx,rho0,swr_frac,ghat,kt)        !<-- formulation implemented in Roms-Agrif
!---------------------------------------------------------------------------------------------------
      implicit none
      integer, intent(in   )                   :: N
      real(8), intent(  out)                   :: Akv     (0:N  )
